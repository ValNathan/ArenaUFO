import 'dart:ui' show Canvas, Image, Offset, Paint, Rect;
...
class Sprite {
  ...
  Sprite(String path, {double width, double height}) : _loaded = false {
  ...
  static Future<Sprite> fromPath(String path,
